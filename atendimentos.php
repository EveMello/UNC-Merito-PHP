...
<head>
  <meta charset="UTF-8" />
  <title>Atendimentos - Sistema de Prontuário Médico</title>
...
<body class="sb-nav-fixed">
              ...
              <div class="row g-3">
                <div class="col-md-6">
                  ...
                  <div class="input-group">
                    ...
                    <button type="button" class="btn btn-outline-secondary mic-select" data-target="at_paciente">🎤</button>
                  </div>
                </div>
                <div class="col-md-6">
                  ...
                  <div class="input-group">
                    ...
                    <button type="button" class="btn btn-outline-secondary mic-select" data-target="at_profissional">🎤</button>
                  </div>
                </div>
                <div class="col-md-6">
                  ...
                  <div class="input-group">
                    ...
                    <button type="button" class="btn btn-outline-secondary mic-select" data-target="at_tipo">🎤</button>
                  </div>
                </div>
                <div class="col-md-6">
                  ...
                  <div class="input-group">
                    ...
                    <button type="button" class="btn btn-outline-secondary mic-select" data-target="at_status">🎤</button>
                  </div>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-12">
                  ...
                  <div class="form-text">Opcional. Máx ~10MB (dependente do PHP).</div>
                </div>
              </div>
            </form>
          </div>
  ...
  <script>
    ...
    //Carregar os médicos no Atendimento:
    ...
    if (SpeechRecognition) {
      ...
      recognition.onerror = () => alert('Erro ao capturar áudio. Verifique se o microfone está liberado!');
    }
    else {
      // Se não tiver suporte, apenas desativa os botões de microfone
      document.querySelectorAll('.mic-btn').forEach(btn => {
        btn.disabled = true;
        btn.title = "Reconhecimento de voz não suportado neste navegador"; // Dica ao passar o mouse
      });
    }

    // -------------------- DITADO POR VOZ CAMPOS DE SELEÇÃO--------------------
    if (SpeechRecognition) {
        ...
        btn.addEventListener('click', () => {
          ...
          recognition.onresult = (event) => {
            ...
            for (let option of selectEl.options) {
              ...
              // Correspondência flexível: se parte da frase falada estiver na opção ou vice-versa
            ...
            if (!matched) {
              alert(`Não encontrei uma opção correspondente para: "${spoken}"`);
            }
          };
        });
      });
